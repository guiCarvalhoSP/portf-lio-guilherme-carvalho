...
export const listCourses: ICourses[] = [
  {
    ...
    learnings: [
      'HTML', 'CSS', 'Javascript', 'NodeJs', 'Angular 12', 'MongoDB', 'MySQL', 'Bootstrap 4/5', 'jQuery', 'Firebase'
    ],
    workload: 740,
  ...
  },
  {
    ...
    learnings: [
      'Java', 'Spring', 'Spring Boot', 'JUnit5', 'TDD', 'MVC', 'REST API', 'Microservices', 'Angular 2+', 'Soft Skills'
    ],
    workload: 516,
    local: "GFT Academy",
  ...
  },
  {
    ...
    learnings: [
      'Java', 'POO', 'Git/Github', 'Spring', 'Debbuging', 'Collections'
    ],
    workload: 56,
    local: "DIO",
